...
h=figure;
set(gcf,'position',[1 1 1200 668],'inverthardcopy','off','color',[1 1 1])
...
ii=1
    ...
    load(['./data/combined_waterlevel_exp3_',ts0,'.mat']);
    clear tmp_plt
    eval(['tmp_plt=combined_waterlevel_exp3_',ts0,';']);
    nn=0;
    nexttile(nn+ii,[1 1]);
    hold on; box on;
...
ylabel(hc,{'(m)'},'FontSize',cb_fontsize,'Rotation',0)
hc.Label.Position(1)=0.5;
hc.Label.Position(2)=2.06;

%% save figure
outfile=['figureS3_estuary_waterlevel_2D.png'];
